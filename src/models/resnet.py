...
from freeze_AT.src.models.tools import Normalize
...
class ResNet(nn.Module):
    ...
    def __init__(self, num_outputs=10):
        ...
        self.init_conv = nn.Conv2d(3, 16, kernel_size=3,
                                   stride=1, padding=1, bias=False)
        ...
        self.last_bn = nn.BatchNorm2d(filters[3])
    ...
    def forward(self, x):
        ...
        out = self.block2(out)
        out = self.block3(out)
        out = F.leaky_relu(self.last_bn(out), 0.1)
